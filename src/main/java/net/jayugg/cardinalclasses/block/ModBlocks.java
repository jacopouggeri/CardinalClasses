...
public class ModBlocks {
    public static final Block SKILL_ALTAR = registerBlock("skill_altar",
            new SkillAltarBlock(FabricBlockSettings.of(Material.STONE).strength(50.0f, 1200.0f).requiresTool()), ModItemGroup.MOD_GROUP);
    public static final Block SHARD_HOLDER = registerBlock("shard_holder",
            new ShardHolderBlock(FabricBlockSettings.of(Material.STONE).strength(50.0f, 1200.0f).requiresTool()), ModItemGroup.MOD_GROUP);
