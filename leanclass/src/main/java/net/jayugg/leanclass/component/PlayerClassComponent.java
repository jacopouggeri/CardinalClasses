...
public class PlayerClassComponent implements ComponentV3, AutoSyncedComponent {
    ...
    public void readFromNbt(NbtCompound tag) {
        ...
        if (!ascendedPerkSlotName.isEmpty()) {
            this.ascendedPerkSlot = PerkSlot.valueOf(ascendedPerkSlotName);
        }
    ...
    public void writeToNbt(NbtCompound tag) {
        ...
        tag.putString("AscendedPerkSlot", ascendedPerkSlot != null ? ascendedPerkSlot.name() : "");
