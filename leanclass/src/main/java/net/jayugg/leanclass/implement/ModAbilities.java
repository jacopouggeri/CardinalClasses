...
public class ModAbilities {
    public static final PlayerSkill BASE_PASSIVE_RED = AbilityRegistry.registerSkill(
            new ExampleAttackSkill("base_passive_red", 0xFF0000));
    public static final PlayerSkill BASE_PASSIVE_BLUE = AbilityRegistry.registerSkill(
            new ExampleAttackSkill("base_passive_blue", 0x0000FF));
    public static final PlayerSkill BASE_PASSIVE_GREEN = AbilityRegistry.registerSkill(
            new ExampleAttackSkill("base_passive_green", 0x00FF00));
    public static final PlayerSkill BASE_PASSIVE_YELLOW = AbilityRegistry.registerSkill(
            new ExampleAttackSkill("base_passive_yellow", 0xFFFF00));
